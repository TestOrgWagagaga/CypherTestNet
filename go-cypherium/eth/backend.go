...
import (
	...
	"github.com/cypherium/CypherTestNet/go-cypherium/core/bloombits"
	...
	"github.com/cypherium/CypherTestNet/go-cypherium/eth/filters"
	...
	"github.com/cypherium/CypherTestNet/go-cypherium/miner"
...
func New(ctx *node.ServiceContext, config *Config) (*Ethereum, error) {
	...
	chainConfig.OnetTomlDir = config.PrivateKeyDir
	...
	eth.miner = miner.New(eth, eth.chainConfig, eth.EventMux(), eth.engine, eth.blockchain)
