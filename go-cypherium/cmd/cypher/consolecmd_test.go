...
func TestConsoleWelcome(t *testing.T) {
	...
	cypher.SetTemplateFunc("gethver", func() string { return params.Version })
...
instance: Cypher/v{{gethver}}/{{goos}}-{{goarch}}/{{gover}}
coinbase: {{.Etherbase}}
at block: 0 ({{niltime}})
 datadir: {{.Datadir}}
 modules: {{apis}}
...
func testAttachWelcome(t *testing.T, cypher *testgeth, endpoint, apis string) {
	...
	attach.SetTemplateFunc("etherbase", func() string { return cypher.Etherbase })
