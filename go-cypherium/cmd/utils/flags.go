...
import (
	...
	"github.com/cypherium/CypherTestNet/go-cypherium/common/fdlimit"
	"github.com/cypherium/CypherTestNet/go-cypherium/consensus"
	"github.com/cypherium/CypherTestNet/go-cypherium/consensus/clique"
	...
	"github.com/cypherium/CypherTestNet/go-cypherium/dashboard"
	...
	"github.com/cypherium/CypherTestNet/go-cypherium/metrics/influxdb"
...
var (
	...
	OnetTomlDirFlag = DirectoryFlag{
		Name:  "onetdir",
		Usage: "Directory to store the onet toml directoy",
		Value: DirectoryString{OnetDefaultDir()},
	}
...
func SetEthConfig(ctx *cli.Context, stack *node.Node, cfg *eth.Config) {
	...
	cfg.PrivateKeyDir = ctx.GlobalString(OnetTomlDirFlag.Name)
