...
Section "Cypher" GETH_IDX
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Cypher incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\cypher.exe" "" "" "Ethereum" 30303 "" "" ""
  SimpleFC::AdvAddRule "Cypher outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\cypher.exe" "" "" "Ethereum" "" 30303 "" ""
  SimpleFC::AdvAddRule "Cypher UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\cypher.exe" "" "" "Ethereum" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\cypher.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\cypher.ipc"
