...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/cypher.ipc",
			endpoint:    "/data/testnet/cypher.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/cypher.ipc",
			endpoint:    "/data/testnet/cypher.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/cypher.ipc",
			endpoint:    "/data/testnet/cypher.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/cypher.ipc",
			endpoint:    "/data/testnet/cypher.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
